...
public class ShroomWorldDialogue : MonoBehaviour
{
    ...
    void Awake()
    {
        Cpanel = GameObject.Find("ShroomPanel").GetComponent<Image>();
        Coutput = GameObject.Find("ShroomText").GetComponent<Text>();
